      ...
      try {
        if (resource === "coin") {
          ...
          if (operation === "get") {
            ...
            if (searchBy === "contractAddress") {
              const platformId = this.getNodeParameter(
                "platformId",
                i
              ) as string;
          ...
          if (operation === "market") {
            const returnAll = this.getNodeParameter("returnAll", i);
            const baseCurrency = this.getNodeParameter(
              "baseCurrency",
              i
            ) as string;
            const options = this.getNodeParameter("options", i);
            ...
            if (options.price_change_percentage) {
              qs.price_change_percentage = (
                options.price_change_percentage as string[]
              ).join(",");
            }
          ...
          if (operation === "price") {
            const searchBy = this.getNodeParameter("searchBy", i) as string;
            const quoteCurrencies = this.getNodeParameter(
              "quoteCurrencies",
              i
            ) as string[];
            const options = this.getNodeParameter("options", i);
            ...
            if (searchBy === "coinId") {
              const baseCurrencies = this.getNodeParameter(
                "baseCurrencies",
                i
              ) as string[];
            ...
            if (searchBy === "contractAddress") {
              ...
              const contractAddresses = this.getNodeParameter(
                "contractAddresses",
                i
              ) as string;
          ...
          if (operation === "marketChart") {
            ...
            const searchBy = this.getNodeParameter("searchBy", i) as string;
            const quoteCurrency = this.getNodeParameter(
              "quoteCurrency",
              i
            ) as string;
        ...
        if (resource === "simple") {
          ...
          if (operation === "price") {
            ...
            const currencies = this.getNodeParameter(
              "currencies",
              i
            ) as string[];
            const options = this.getNodeParameter("options", i);
